...
$sql = "SELECT * from studententry1";
$sqll = "SELECT * from studententry2";
$sqlll = "SELECT * from studententry";
if ($result = mysqli_query($cond, $sql)) {
 ...
 if ($resultt = mysqli_query($cond, $sqll)) {
...
if ($resulttt = mysqli_query($cond, $sqlll)) {
...
<body>
  ...
  <div class="container">
    ...
    <div class="log" style="margin-left: -4%;">
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <h2>C2</h2>
      ...
      <p>Total Strength: <?php echo $rowcountt;?></p>
    </div>
  </div>
</div>
</a>

<a href="new_attendence3.php">
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <!-- <img src="notice.png" alt=""> -->
    ...
    <h2>C3</h2>
      ...
      <p>Total Strength: <?php echo $rowcounttt;?></p>
    </div>
  </div>
</div>
</div>
