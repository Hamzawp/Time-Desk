...
<div class="navbar" style=" justify-content: left;">
    ...
    <div class="outermost" style="margin-top: 7vh;">
        <div class="information">
            <h3 id="welcometxt">Welcome C2</h3>
            <div id="text">
                Please fill the data correctly
            </div>
            <button id="btn1"><a href="display2.php" target="main">Check Form</a></button>
        </div>
        <div class="form">
...
if(isset($_POST['submit'])) //It is super global variable that is used to collect form data after submitting an HTML form with method = post
{
    ...
    $insertquery = "insert into studententry2(fname,lname,rollno,email) values('$pfname','$plname','$prollno','$pemailid')";
...
if(isset($_POST["submit"]))
{
    ...
    <script>
    alert('Sent');
    document.location.href = 'new_attendence2.php';
    </script>
    ";
}
?>