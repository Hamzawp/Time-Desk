...
<div class="navbar" style=" justify-content: left;">
    ...
    <div class="outermost" style="margin-top: 7vh;">
        <div class="information">
            <h3 id="welcometxt">Welcome C1</h3>
            <div id="text">
                Please fill the data correctly
            </div>
            <button id="btn1"><a href="display1.php" target="main">Check Form</a></button>
        </div>
        <div class="form">
            <form action="#" class="add_st_form" id="new-student-form" method="POST">
            <div class="form-box">
...
if(isset($_POST["submit"]))
{
    ...
    <script>
    alert('Sent');
    document.location.href = 'new_attendence1.php';  //change it
    </script>
    ";
}
?>