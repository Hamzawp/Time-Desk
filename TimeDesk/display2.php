...
<!--<div class="image">
    ...
    <div class="attendance-sheet">
        <div class="parental" style="display: flex; align-items: center;">
            ...
            <h2><a href="resetkardo2.php" class="heading-primary-sub" style=" margin-bottom: -10%;  margin-left: -220%; font-size: 1rem;margin-top:30%; border:1px solid #454ea0; letter-spacing: 2px; background-color:rgb(255, 248, 220); color:#454ea0; font-weight:bold; cursor:pointer;text-decoration:none; border-radius:5px; padding: 10px 10px 10px 10px;">RESET</a></h2>
            </div>

            <div class="as-heading" style="margin-bottom: 2vh;">
                <h2 class="heading-primary-sub">WELCOME TO CLASS - C2</h2>
            </div>
...
if(!isset($_SESSION['username'])){
    ...
    $selectquery = "select * from studententry2";
    ...
    while($res = mysqli_fetch_array($query)){
        ...
        <tr>
                ...
                <form method="post">
                    <a href="presentkaro2.php?idth=<?php echo $res['rollno']?>" class="pres-btn" style="
                    ...
                    <a href="absentkaro2.php?idth=<?php echo $res['rollno']?>" class="abse-btn" style="
                                                     text-decoration:none;
                                                    padding: 10px;
                                                    margin-left:15px ;
                                                    width: 7vw;
        ...
        $("body").on("click", "#heading-primary-subs", function () {
            html2canvas($('#as-table')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("C2-Attendance-Report.pdf");
                }
            });
        });
</script>        
